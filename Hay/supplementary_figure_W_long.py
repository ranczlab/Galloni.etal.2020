...
if path.exists('outputs/data/supplementary_figure_W_long.csv'):
    with open(r'outputs/data/supplementary_figure_W_long.csv', 'a') as f:
        writer = csv.writer(f)
        writer.writerow(fields)
else:
    with open(r'outputs/data/supplementary_figure_W_long.csv', 'w') as f:
        writer = csv.writer(f)
