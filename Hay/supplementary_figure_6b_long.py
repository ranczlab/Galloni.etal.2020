...
if path.exists('outputs/data/supplementary_figure_6b_long.csv'):
    with open(r'outputs/data/supplementary_figure_6b_long.csv', 'a') as f:
        writer = csv.writer(f)
        writer.writerow(fields)
else:
    with open(r'outputs/data/supplementary_figure_6b_long.csv', 'w') as f:
        writer = csv.writer(f)
