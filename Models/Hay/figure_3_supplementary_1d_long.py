...
if path.exists('outputs/data/figure_3_supplementary_1d_long.csv'):
    with open(r'outputs/data/figure_3_supplementary_1d_long.csv', 'a') as f:
        writer = csv.writer(f)
        writer.writerow(fields)
else:
    with open(r'outputs/data/figure_3_supplementary_1d_long.csv', 'w') as f:
        writer = csv.writer(f)
