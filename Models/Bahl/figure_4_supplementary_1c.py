...
for i in range(lengths.size):
    ...
    with open(r'outputs/data/figure_4_supplementary_1c.csv', 'a') as f:
        writer = csv.writer(f)
    ...
    with open(r'outputs/data/figure_4_supplementary_1c_baselines.csv', 'a') as f:
        writer = csv.writer(f)
        writer.writerow(fields)
...
plt.savefig('outputs/figures/figure_4_supplementary_1c.svg')