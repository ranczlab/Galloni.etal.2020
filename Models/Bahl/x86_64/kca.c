...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /Users/aeron/Github/shortneurons/models/bahl/x86_64/kca.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 78 in file kca.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/aeron/Github/shortneurons/models/bahl/channels/kca.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
